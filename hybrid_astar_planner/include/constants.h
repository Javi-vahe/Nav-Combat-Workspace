...
/// 膨胀范围
static const double bloating = 0.02; 

/// [m] --- The width of the vehicle
static const double width = 0.11 + 2 * bloating;//车的宽度

/// [m] --- The length of the vehicle
static const double length = 0.255 + 2 * bloating;//车的长度
...
static const double r = 0.35;  // real 0.296
